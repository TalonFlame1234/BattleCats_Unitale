...
music = "Battle Cats" --Always OGG or WAV. Extension is added automatically. Remove the first two lines for custom music.
...
possible_attacks = {"bullettest_bouncy", "bullettest_touhou", "bullettest_chaseorb"}
